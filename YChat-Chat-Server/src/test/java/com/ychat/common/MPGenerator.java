...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/YChat-Chat-Server/src/main/java");

        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/zongzibinbin\">Rhss</a>");
        ...
        packageConfig.setParent("com.ychat.common.user");//自定义包的路径
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("zyj2021823");
        dataSourceConfig.setUrl("jdbc:mysql://139.224.188.112:3306/ychat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}