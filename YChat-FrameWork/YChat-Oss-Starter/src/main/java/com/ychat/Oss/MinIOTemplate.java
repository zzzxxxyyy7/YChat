...
public class MinIOTemplate {
    ...
    public OssResp getPreSignedObjectUrl(OssReq req) {
        ...
        GetPresignedObjectUrlArgs GetPresignedBuild = GetPresignedObjectUrlArgs.builder()
                .method(Method.PUT)
        ...
        String url = minioClient.getPresignedObjectUrl(GetPresignedBuild);
